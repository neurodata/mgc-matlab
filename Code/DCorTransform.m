...
%% @export
%%
function [A,B,RX,RY]=DCorTransform(X,Y,optionCenter,optionRank)
if nargin<3
...
[A,RX]=DistCentering(X,optionCenter,optionRank);
[B,RY]=DistCentering(Y,optionCenter,optionRank);
...
%%
function [A,RX]=DistCentering(X,optionCenter,optionRank)
[n]=size(X,1);
if optionRank~=0
