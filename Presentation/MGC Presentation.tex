...
\pause
\medskip
4. Invariant: $c(\mathcal{X}_{n},\mathcal{Y}_{n})=c(\{\phi(x_{i})\},\{\delta(y_{i})\})$ for any distance-preserving transformations $\phi,\delta$ (i.e., rotation, scaling, translation, reflection).\\
\pause
\medskip
