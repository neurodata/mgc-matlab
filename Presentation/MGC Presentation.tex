...
\pause
\medskip
To that end, we propose the \textbf{multiscale graph correlation} in [\textit{Shen et al.(2017a)}]\cite{ShenEtAl2016}.
\end{frame}
...
multiscale graph correlation," \textit{https://arxiv.org/abs/1710.09768}.\\
\bigskip
